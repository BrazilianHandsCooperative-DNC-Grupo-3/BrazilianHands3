      ...
      <section>
        <div className='container'>
          ...
          <div className='mission'>
              <h2 className='title-h2'>Mission</h2>
              <p className='text-align'>
              ...
              <h2 className='title-h2'>Vision</h2>
              <p className='text-align'>
          ...
          <div className='mission'>
            <h2 className='title-h2'>Why Choose Brazilian Hands Cooperative?</h2>
            <p className='text-align'>
          ...
          <div className='vision'>
            ...
            <p className='text-center'>Get in touch with our talented and dedicated team today!</p>
            <Link to="/contactUS">
